...
public class MudAlphaNavigationBar: MudNavigationBar {
    ...
    class public func alphaBar()->MudAlphaNavigationBar {
        let alphaBar = MudAlphaNavigationBar(frame: CGRectMake(0, 20, MudScreen.width, 44))
        return alphaBar
    }
    ...
    private func setupView() {
        ...
        self.setBackgroundImage(UIImage.imageWithColor(UIColor.clearColor(), andSize: CGSizeMake(MudScreen.width, 0.5)), forBarMetrics: UIBarMetrics.Default)
        self.shadowImage = UIImage.imageWithColor(UIColor.clearColor(), andSize: CGSizeMake(MudScreen.width, 0.5))
        ...
        self.barBackgroundView = UIView(frame: CGRectMake(0,0,MudScreen.width,44))
...
public class MudNavigationView: UIView {
    ...
    private func setupView() {
        self.backgroundColor = UIColor.clearColor()
        self.statusView = UIView(frame: CGRectMake(0,0,MudScreen.width,20))
