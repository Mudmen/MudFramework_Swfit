//
//  MudKeyChainManager.swift
//  Travel
//
//  Created by TimTiger on 10/31/15.
...
public class MudKeyChainManager {
    ...
    private class func setupKeychainQueryDictionaryForKey(keyName: String) -> [String:AnyObject] {
        ...
        keychainQueryDictionary[SecAttrService] = MudKeyChainManager.serviceName
        
        // Set the keychain access group if defined
        if !MudKeyChainManager.accessGroup.isEmpty {
            keychainQueryDictionary[SecAttrAccessGroup] = MudKeyChainManager.accessGroup
        }
